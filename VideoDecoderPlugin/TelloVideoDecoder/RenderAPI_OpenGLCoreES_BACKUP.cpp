...
class RenderAPI_OpenGLCoreES_Backup : public RenderAPI
{
public:
	RenderAPI_OpenGLCoreES_Backup(UnityGfxRenderer apiType);
	virtual ~RenderAPI_OpenGLCoreES_Backup() { }
...
RenderAPI* CreateRenderAPI_OpenGLCoreES_Backup(UnityGfxRenderer apiType)
{
	return new RenderAPI_OpenGLCoreES_Backup(apiType);
}
...
void RenderAPI_OpenGLCoreES_Backup::CreateResources()
{
	// Create shaders
...
RenderAPI_OpenGLCoreES_Backup::RenderAPI_OpenGLCoreES_Backup(UnityGfxRenderer apiType) : m_APIType(apiType) {}


void RenderAPI_OpenGLCoreES_Backup::ProcessDeviceEvent(UnityGfxDeviceEventType type, IUnityInterfaces* interfaces)
{
...
void RenderAPI_OpenGLCoreES_Backup::DrawSimpleTriangles(const float worldMatrix[16], int triangleCount, const void* verticesFloat3Byte4)
{
...
void* RenderAPI_OpenGLCoreES_Backup::BeginModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int* outRowPitch)
{
...
void RenderAPI_OpenGLCoreES_Backup::EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int rowPitch, void* dataPtr)
{
...
void* RenderAPI_OpenGLCoreES_Backup::BeginModifyVertexBuffer(void* bufferHandle, size_t* outBufferSize)
{
...
void RenderAPI_OpenGLCoreES_Backup::EndModifyVertexBuffer(void* bufferHandle)
{
#	if !SUPPORT_OPENGL_ES
	glBindBuffer(GL_ARRAY_BUFFER, (GLuint)(size_t)bufferHandle);
